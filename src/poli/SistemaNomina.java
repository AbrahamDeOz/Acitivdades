...
public class SistemaNomina {
    ...
    public static void main(String[] args) {
        ...
        EmpleadoAsalariado empleadoAsalariado = new EmpleadoAsalariado("Abraham", "Gomez", "2155319", 800.00);
        EmpleadoBaseMasComision empleadoBaseMasComision = new EmpleadoBaseMasComision("Gustavo", "Salinas", "4509786", 5000, .40, 300);
        EmpleadoPorComision empleadoPorComision = new EmpleadoPorComision("Carmen", "Castillo", "7893021", 1000, .60);
        EmpleadoPorHoras empleadoPorHoras = new EmpleadoPorHoras("Carmen", "Castillo", "7089321", 16.75, 40);
